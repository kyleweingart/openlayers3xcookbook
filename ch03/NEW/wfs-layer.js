      ...
      url: url, dataType: 'jsonp', success: function (response) {
        if (response.error) {
          ...
          if (features.length > 0) {
            ...
            console.log(features[0].H.dataapi + 'datagetter?date=latest&datum=MLLW&units=english&time_zone=gmt&format=json&station=' + features[0].H.id + '&product=water_level');
          }
        }
      }
    });
